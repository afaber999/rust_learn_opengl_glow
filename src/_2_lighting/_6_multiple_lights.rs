...
pub fn main_2_6() {
    ...
    unsafe 
    {
        ...
        let window_builder = glutin::window::WindowBuilder::new()
            .with_title("learn-opengl-glow =>  _6_multiple_lights")
        ...
        event_loop.run(move |event, _, control_flow| {
            ...
            match event {
                Event::RedrawRequested(_) => {
                    ...
                    // light properties
                    shader_cube.set_uniform_vec3("light.position",&camera.get_position());
                    shader_cube.set_uniform_vec3("light.direction", &camera.get_front());
                    shader_cube.set_uniform_f32("light.cutOff", 12.5f32.to_radians().cos());
                    shader_cube.set_uniform_f32("light.outerCutOff", 17.5f32.to_radians().cos());

                    // we configure the diffuse intensity slightly higher; the right lighting conditions
                    // differ with each lighting method and environment.
                    // each environment and lighting type requires some tweaking to get the best out of your environment.
                    shader_cube.set_uniform_3_f32("light.ambient", 0.1,0.1,0.1);
                    shader_cube.set_uniform_3_f32("light.diffuse", 0.8,0.8,0.8);
