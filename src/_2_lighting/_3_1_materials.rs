...
pub fn main_2_3_1() {
    ...
    unsafe 
    {
        ...
        let window_builder = glutin::window::WindowBuilder::new()
            .with_title("learn-opengl-glow => _3_1_materials")
        ...
        event_loop.run(move |event, _, control_flow| {
            ...
            match event {
                Event::RedrawRequested(_) => {
                    ...
                    shader_cube.set_uniform_vec3("light.ambient", &ambient_color);
                    shader_cube.set_uniform_vec3("light.diffuse", &diffuse_color);
                    shader_cube.set_uniform_3_f32("light.specular", 1.0, 1.0, 1.0);
        
                    // material properties
                    shader_cube.set_uniform_3_f32("material.ambient", 1.0, 0.5, 0.31);
                    shader_cube.set_uniform_3_f32("material.diffuse", 1.0, 0.5, 0.31);
                    shader_cube.set_uniform_3_f32("material.specular", 0.5, 0.5, 0.5); // specular lighting doesn't have full effect on this object's material
