...
pub fn main_2_2_2() {
    ...
    unsafe 
    {
        ...
        let window_builder = glutin::window::WindowBuilder::new()
            .with_title("learn-opengl-glow => _2_2_basic_lighting_specular")
        ...
        event_loop.run(move |event, _, control_flow| {
            ...
            match event {
                Event::RedrawRequested(_) => {
                    ...
                    shader_cube.set_uniform_vec3("objectColor", &glm::vec3(1.0, 0.5, 0.31));
                    shader_cube.set_uniform_vec3("lightColor", &glm::vec3(1.0, 1.0, 1.0)); 
                    shader_cube.set_uniform_vec3("lightPos", &light_pos); 
