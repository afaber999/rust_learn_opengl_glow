...
pub fn main_1_3_1() {
    ...
    unsafe 
    {
        ...
        let window_builder = glutin::window::WindowBuilder::new()
            .with_title("learn-opengl-glow => _3_1_shaders_uniform")
        ...
        event_loop.run(move |event, _, control_flow| {
            ...
            match event {
                Event::RedrawRequested(_) => {
                    ...
                    let green_value = ((frame_time ).sin() / 2.0) + 0.5;
                    let our_color = gl.get_uniform_location(program, "ourColor");
                    gl.uniform_4_f32(our_color.as_ref(), 0.0, green_value, 0.0, 0.0);
